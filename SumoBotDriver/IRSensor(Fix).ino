...
unsigned int IRSensors[]       = {4};        // Array containing all the current IRSensor pins. 

unsigned int numOfIRSensors    = 1;            

unsigned int ROBOTARRSIZE      = 5;            // Unrelated to IRSensors[] array. It is the amount of values to 
